    ...
    return (
      <div className="space-y-4 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">{t("successBody")}</p>
        </div>
      </div>
    );
  }
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div>
          ...
          {state.fieldErrors?.["password"] ? (
            ...
            <p id="password-hint" className="mt-1 text-xs text-gray-500 dark:text-gray-500">
              {t("passwordHint")}
            </p>
          )}
        </div>
